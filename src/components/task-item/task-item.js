...
const TaskItem = ({ title, description, onDelete }) => {
	...
	let itemTextClasses = 'task-item__text';
	const [complete, setComplete] = useState(false)
	const onComplete = () => {
		setComplete(!complete)
	}
	if (complete) {
		itemTextClasses += ' complete';
	}
	...
	return (
		<li className="task-item">
			...
			<div className="task-item__done" onClick={onComplete}>
				<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" version="1.1" viewBox="0 0 32 32">
					<g transform="scale(2)">
						<circle fill="#4caf50" cx="8" cy="8" r="7" />
						<path fill="#ffffff" d="M 11.535,4.4 7.2928,8.6 4.4647,5.8 3.0506,7.2 5.8787,10.1 7.2928,11.5 12.949,5.8 Z" />
					</g>
				</svg>
			</div>

			<div className="task-item__remove" onClick={onDelete}>
				<svg
					width="20"
					height="20"
					enableBackground="new 0 0 40 40" version="1.1" viewBox="0 0 40 40" >
